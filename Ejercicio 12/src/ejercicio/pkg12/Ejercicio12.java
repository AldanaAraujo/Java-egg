...
*/
     ...
     int bomba;
     System.out.println("Ingrese el indice de referencia de la bomba");
     Scanner indice= new Scanner(System.in);
     bomba=indice.nextInt();
     if ((bomba>0)&&(bomba<5)){
         switch (bomba){
             case 1: 
         ...
         System.out.println("El insiso agregado no es valido como clasificación de la bomba");
     }
